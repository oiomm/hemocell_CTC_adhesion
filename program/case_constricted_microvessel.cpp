...
int main(int argc, char *argv[]) {
  ...
  //OUTPUT_SHEAR_RATE,OUTPUT_STRAIN_RATE,OUTPUT_SHEAR_STRESS,
  //outputs = {OUTPUT_SHEAR_RATE, OUTPUT_STRAIN_RATE,OUTPUT_SHEAR_STRESS,OUTPUT_BOUNDARY,OUTPUT_VELOCITY,OUTPUT_DENSITY,OUTPUT_FORCE};报错
